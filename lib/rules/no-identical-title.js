 ...
 *
 * @param {import("eslint").Rule.Node} node - The AST node to evaluate for a
 *   static string value
 * @returns {string | null} The evaluated string value, or `null` when it cannot
...
export default {
  meta: {
    ...
    docs: {
      ...
      recommended: false,
      url: "https://github.com/chris48s/eslint-plugin-node-core-test/blob/main/docs/rules/no-identical-title.md",
    },
    fixable: null,
    schema: [],
    messages: {
