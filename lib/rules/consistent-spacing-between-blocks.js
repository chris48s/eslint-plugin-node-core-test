 ...
 *   object used to inspect tokens and comments
 ...
 * @returns {boolean} True when there is at least one blank line between
 *   `prevToken` and the start of `node`, otherwise false
 */
...
export default {
  meta: {
    ...
    docs: {
      ...
      recommended: false,
      url: "https://github.com/chris48s/eslint-plugin-node-core-test/blob/main/docs/rules/consistent-spacing-between-blocks.md",
    },
    fixable: "whitespace",
    schema: [],
    messages: {
